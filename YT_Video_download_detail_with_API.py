...
#https://www.youtube.com/watch?v=zzwRbKI2pn4
#file location
def openLocation():
    global Folder_Name
...
def video_details():
    ...
    details.config(width=100,bg="brown",fg="white",text=f"Channel Title :- {channelTitle}\nTotal video on channel :- {t_video}\nTotal Subs :-{t_sub}\nTotal Watch time :-{t_watch}\n\nVideo title:- {title}\nLikes:- {likes}\nViews:- {views}")
...
#developer Label
developerlabel = Label(root,text="YOUTUBE VIDEO DOWLODER",bg='#b4aee8',fg='white',font=("jost",20),width="30",borderwidth=10,padx=10,pady=10)
...
#btn of save file
saveEntry = Button(root,width=10,bg="red",fg="white",padx=10,pady=10,text="Choose Path",command=openLocation)
...
#Download Quality
ytdQuality = Label(root,bg='#262626',padx=10,pady=10,fg='white',text="Select Quality",font=("jost",15))
...
#donwload btn
downloadbtn = Button(root,text="Donwload",border="0",width=10,bg="red",fg="white",command=DownloadVideo)
...
Button(root,text="Video Details",width=20,font=("jost",20),bg="orange",border="0",fg="black",command=video_details,padx=10,pady=10).grid()
